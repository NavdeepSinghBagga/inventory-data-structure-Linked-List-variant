...
void menu()
{
	...
	printf("----------------------------------\n");
	printf("11-Update at given index\n");
	printf("12-Convert to numerical value\n");
	printf("13-Check for file validation\n");
	printf("14-Query Processor\n");
	printf("15-Add new property\n");
	printf("16-linked List representation of inventory data\n");
	printf("--------------------------------\n");
}
...
int main()
{
	...
	while (1)
	{
		...
		case 10: add_key();
			break;
		case 11: update_at_index();
			break;
		case 12: covert_to_integer();
			break;
		case 13: file_check();
			break;
		case 14: query_processor();
			break;
		case 15: new_property();
			break;
		case 16: main_structure();
			break;
